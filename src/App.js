        ...
        <section className="hero-section" aria-labelledby="hero-title" style={{ marginTop: '8rem' }}>
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              A fresh graduate frontend developer with a growing passion for UI/UX design. I aim to create impactful user experiences by leveraging my frontend development skills to seamlessly bring designs to life.
              </Typography>
            </Grid>
